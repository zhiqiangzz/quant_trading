...
for train_round, seed, process_row, drop_row, eta in itertools.product(
    train_rounds, seeds, process_rows, drop_rows, etas
):
    ...
    if process_row > 0:
        X_local.loc[X_local.index[:process_row], "ROC_0"] *= 2
        # w_local[:process_row] *= 0.00000000001
